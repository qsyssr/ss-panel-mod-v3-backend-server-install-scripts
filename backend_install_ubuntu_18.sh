...
if [ ! -d "shadowsocks" ]; then
	...
	cd /tmp && git clone -b master https://github.com/lizhongnian/shadowsocks.git
...
wget -O rc.local https://raw.githubusercontent.com/qsyssr/ss-panel-mod-v3-backend-server-install-scripts/master/rc.local_ubuntu_18 && chmod +x rc.local
mv -f rc.local /etc
